...
uca_org_t cacti_interface(int cache_size,int line_size,int associativity,int rw_ports,int banks,int output_width,int tag_width) 
{
  ...
  g_ip->ic_proj_type     = 1;
  g_ip->wire_is_mat_type = 2;
  g_ip->wire_os_mat_type = 2;
  g_ip->burst_len        = 8;
  g_ip->int_prefetch_w   = 8;
  g_ip->page_sz_bits     = 8192;
  ...
  g_ip->specific_tag        = true;
  g_ip->tag_w               = tag_width;  

  g_ip->access_mode         = 0;
  g_ip->delay_wt = 0;
  g_ip->dynamic_power_wt = 0;
  g_ip->leakage_power_wt = 0;
  g_ip->area_wt = 100;
  g_ip->cycle_time_wt    = 0;
  g_ip->delay_dev = 60;
  g_ip->dynamic_power_dev = 100000;
  g_ip->leakage_power_dev = 100000;
  g_ip->area_dev = 1000000;
  g_ip->cycle_time_dev    = 100000;
  g_ip->ed = 0;
  ...
  g_ip->delay_wt_nuca = 100;
  g_ip->dynamic_power_wt_nuca = 100;
  g_ip->leakage_power_wt_nuca = 0;
  g_ip->area_wt_nuca = 100;
  g_ip->cycle_time_wt_nuca    = 0;
  g_ip->delay_dev_nuca = 10;
  g_ip->dynamic_power_dev_nuca = 10000;
  g_ip->leakage_power_dev_nuca = 10000;
  g_ip->area_dev_nuca = 10000;
  g_ip->cycle_time_dev_nuca    = 10000;
  g_ip->nuca = 0;
  g_ip->nuca_bank_count = 0;
  g_ip->force_nuca_bank = 0;
